...
},{"react/lib/DOMLazyTree":40,"react/lib/ReactMultiChildUpdateTypes":108,"react/lib/createMicrosoftUnsafeLocalFunction":144,"react/lib/setInnerHTML":165,"react/lib/setTextContent":166}],2:[function(require,module,exports){
/**
...
},{"react/lib/createMicrosoftUnsafeLocalFunction":144,"react/lib/setTextContent":166}],3:[function(require,module,exports){
(function (global){
'use strict';
...
var ChartsReactPlugin = {
  eventTypes: {},

  extractEvents: function (topLevelType, targetInst, nativeEvent, nativeEventTarget) {
    var targetNode = targetInst && ReactDOMComponentTree.getNodeFromInstance(targetInst);

    if (!customTopLevelTypes.hasOwnProperty(topLevelType) || !isVaadinChart(targetNode)) {
      return null;
    }
    var event = SyntheticEvent.getPooled(customTopLevelTypes[topLevelType], targetInst, nativeEvent, nativeEventTarget);
...
function registerEvent(name, bubbled, captured) {
  ...
  ReactBrowserEventEmitter.ReactEventListener.trapBubbledEvent(topLevelType, name, document);

  ChartsReactPlugin.eventTypes[bubbled] = EventPluginRegistry.eventNameDispatchConfigs[bubbled] = customTopLevelTypes[topLevelType] = dispatchConfig;

  EventPluginRegistry.registrationNameModules[bubbled] = EventPluginRegistry.registrationNameModules[captured] = ChartsReactPlugin;

  EventPluginRegistry.registrationNameDependencies[bubbled] = EventPluginRegistry.registrationNameDependencies[captured] = dispatchConfig.dependencies;
}
...
function injectAll() {
  ...
  ReactInjection.EventPluginHub.injectEventPluginsByName({ ChartsReactPlugin: ChartsReactPlugin });
...
DefaultEventPluginOrder.push(keyOf({ ChartsReactPlugin: null }));

if (!Polymer) {
  console.warn('vaadin-charts-react: Polymer is not loaded');
}
...
DOMPropertyOperations.setValueForAttribute = function (node, name, value) {
  ...
  if (name !== 'className') {
    return oldSetValueForAttribute(node, name, value);
  }
...
},{"./ShadyDOMChildrenOperations":1,"./ShadyDOMLazyTree":2,"fbjs/lib/keyOf":24,"react":170,"react/lib/DOMChildrenOperations":39,"react/lib/DOMLazyTree":40,"react/lib/DOMPropertyOperations":43,"react/lib/DefaultEventPluginOrder":45,"react/lib/EventConstants":48,"react/lib/EventPluginRegistry":50,"react/lib/EventPluginUtils":51,"react/lib/EventPropagators":52,"react/lib/ReactBrowserEventEmitter":59,"react/lib/ReactDOM":68,"react/lib/ReactDOMComponentTree":72,"react/lib/ReactInjection":100,"react/lib/SyntheticEvent":130}],4:[function(require,module,exports){
// main.js
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'title',
                    null,
                    'Browser market shares at a specific website, March 2015'
                ),
                React.createElement(
                    'subtitle',
                    null,
                ...
                React.createElement('x-axis', { type: 'category' }),
                React.createElement(
                    'y-axis',
                    null,
                    React.createElement(
                        'title',
                        null,
                        'Total percent market share'
                    )
                ),
                React.createElement('legend', { enabled: 'false' }),
                React.createElement(
                    'plot-options',
                    null,
                    React.createElement(
                        'series',
                        null,
                        React.createElement('data-labels', { enabled: 'true', format: '{point.y:.1f}%' })
                    )
                ),
                React.createElement(
                    'data-series',
                ...
                React.createElement(
                    'data-series',
                    { id: 'Microsoft Internet Explorer', drilldown: 'true' },
                    React.createElement(
                        'name',
                        null,
                        'Microsoft Internet Explorer'
            ...
            React.createElement(
                ...
                React.createElement('tooltip', { 'point-format': '<b>{point.percentage:.1f}%</b>' }),
                React.createElement(
                    'plot-options',
                    null,
                    React.createElement(
                        'pie',
                        { 'allow-point-select': 'true', 'show-in-legend': 'true',
                            cursor: 'pointer' },
                        React.createElement('data-labels', { enabled: 'true',
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'data',
                        null,
                        this.state.data3.map(JSON.stringify).join(',')
                    )
                )
            )
        );
...
ReactDOM.render(React.createElement(MyChart, null), document.getElementById('example'));

},{"./bower_components/vaadin-charts/directives/react":3,"react":170,"react-dom":32}],5:[function(require,module,exports){
(function (process){
'use strict';
